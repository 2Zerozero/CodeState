...
const convertToDiscussion = (obj) => {
  ...
  discussionContent.append(ContentTitle); // discussionContent 뒤에 discussion__title 를 추가.
  ContentTitle.append(ContentTitleB); // discussion__title 뒤에 a 를 추가.
  ...
  checked.textContent = obj.answer ? "✔️" : "❌" ; // 3항 연산자 참이면 왼쪽, 거짓이면 오른쪽을 출력한다.
